...
<head>
    <meta charset="UTF-8">
    <title>Solicitud de Asignación de Número de Serie a pedido</title>
    <style>
        body {
...
<body>
    <div class="container">
        <h2>Solicitud de Asignación de Número de Serie a pedido</h2>

        <p>
            Por medio del presente, se solicita la revisión del historial del siguiente cliente para la aprobación del pedido con folio
