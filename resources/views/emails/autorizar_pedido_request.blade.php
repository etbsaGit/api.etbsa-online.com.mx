...
<head>
    <meta charset="UTF-8">
    <title>Solicitud de Autorización de Pedido</title>
    <style>
        body {
...
<body>
    <div class="container">
        <h2>Solicitud de Autorización de Pedido</h2>

        <p>
            Por medio del presente, el empleado
            <strong>{{ $tracking->vendedor->nombreCompleto }}</strong>
            solicita la autorización del siguiente pedido para seguir con el proceso de venta:
        </p>
