...
<head>
    ...
    <title>Solicitud de Vacaciones Eliminada </title>
    <style>
        body {
...
<body>
    <div class="container">
        <div class="header">
            <h1>Solicitud de vacaciones Eliminada</h1>
        </div>
        <div class="content">
            <h3>Estimado/a:</h3>
            <p>Le informamos que <strong>{{ $data['empleado']['nombreCompleto'] }}</strong> eliminó una solicitud de
                vacaciones, favor de
