...
class PutRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            "pasaporte" => ['nullable', 'string', 'mas:255', Rule::unique('empleados')->ignore($this->route("empleado")->id)],
            "visa" => ['nullable', 'numeric', 'digits:16', Rule::unique('empleados')->ignore($this->route("empleado")->id)],
