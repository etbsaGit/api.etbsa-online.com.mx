...
class PutRentalPeriodRequest extends FormRequest
{
    /**
    ...
    public function rules(): array
    {
        ...
        return [
            'folio' => ['required', 'string', 'max:50', Rule::unique('rental_periods')->ignore($this->route('rentalPeriod')->id)],
            ...
            'rental_machine_id' => [
                ...
                function ($attribute, $value, $fail) {
                    ...
                    $conflictingPeriod = \App\Models\RentalPeriod::where('rental_machine_id', $value)
                        ->where('id', '!=', $this->route('rentalPeriod')->id) // Excluir el registro actual
